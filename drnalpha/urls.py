...
from drnalpha.search import views as search_views
from drnalpha.utils.cache import get_default_cache_control_decorator
...
private_urlpatterns = [
    ...
    path("accounts/", include("drnalpha.users.urls")),
    path("company/", include("drnalpha.companies.urls")),
    path("finder/", include("drnalpha.finder.urls")),
    path("tracker/", include("drnalpha.tracker.urls")),
]
...
if getattr(settings, "PATTERN_LIBRARY_ENABLED", False) and apps.is_installed(
    ...
    from drnalpha.project_styleguide.views import example_form
...
# Error handlers
handler404 = "drnalpha.utils.views.page_not_found"
handler500 = "drnalpha.utils.views.server_error"
